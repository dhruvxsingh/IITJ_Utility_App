...
class BLAPage extends StatelessWidget {
  const BLAPage({Key? key}) : super(key: key);

  Widget buildRow(BuildContext context, LiteraryCategoryData categoryData) {
    return Column(
      children: [
        Row(
