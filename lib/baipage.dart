...
class BAIPage extends StatelessWidget {
  const BAIPage({Key? key}) : super(key: key);

  Widget buildRow(BuildContext context, AcademicCategoryData categoryData) {
    return Column(
      children: [
        Row(
