...
class BIEPage extends StatelessWidget {
  const BIEPage({Key? key}) : super(key: key);

  Widget buildRow(BuildContext context, InnovationCategoryData categoryData) {
    return Column(
      children: [
        Row(
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            Text(
              "Board of Innovation and Entrepreneurship",
              style: GoogleFonts.inriaSerif(
                color: Colors.black,
                fontSize: 24,
                fontWeight: FontWeight.bold,
