...
class BCDPage extends StatelessWidget {
  const BCDPage({Key? key}) : super(key: key);

  Widget buildRow(BuildContext context, CareerCategoryData categoryData) {
    return Column(
      children: [
        Row(
